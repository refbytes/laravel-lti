...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-lti.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-lti)
...
```bash
php artisan vendor:publish --tag="laravel-lti-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-lti-views"
```

## Usage

```php
$lti = new RefBytes\Lti();
echo $lti->echoPhrase('Hello, RefBytes!');
```
